...
//                            ((ILoginView) loginRepository).onLoginEventComplete(new Result.Success<>(new LoggedInUser(user)));
//                        } else {
//                            // If sign in fails, display a message to the user.
//                            Log.w(TAG, "signInWithEmail:failure", task.getException());
//                            ((ILoginView) loginRepository).onLoginEventComplete(new Result.Error(new IOException("Error logging in")));
//                        }
//                    }
//                });
//    }
